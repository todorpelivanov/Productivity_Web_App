...
namespace ProductivityApp.Controllers
{
    ...
    public class RemindersController : ControllerBase
    {
        ...
        [HttpGet("GetAllRemindersPagination")]
        public async Task<ActionResult<List<ReminderDto>>> GetAllRemindersWithPagination([FromQuery] int pageNum, [FromQuery] int pageSize)
        {
            try
            {

                var authUser = GetAuthorizedUserId();
                //var pagedData = _reminderService.GetAllReminderWithPagination(authUser, pageNum, pageSize);
                return Ok(await _reminderService.GetAllReminderWithPagination(authUser, pageNum, pageSize));
        ...
        public async Task<IActionResult> UpdateUserSession([FromBody] UpdateReminderDto updateReminderDto)
        {
            try
            {
