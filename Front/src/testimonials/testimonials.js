...
for(let i =0; i < testimonialsItem.length; i ++) {
    ...
    <div class="testimonials-text">
        ...
        <p>For a guy who has tons of tasks per day, keeping track of all the things one must do, thus, not forgetting anything is ultra important. I was having problems remembering everything i need to do, nor i could keep track of the progress of my stuff. When a friend told me this app i instantly tried it and turned my life around. Keeping track of stuff became an issue no more, with extra few things to help along the way, it's the perfect app and i gladly reccomend it to anyone. </p>
        <div class="testimonials-avatar">
