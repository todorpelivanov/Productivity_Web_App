...
let prioForReminderContainer = document.getElementById("selectPrioforReminder");
let getBackToHomeButton = document.getElementById("homePageLogo");
...
selectedPriorityReminder.forEach((selected) => {
  selected.addEventListener("click", () => {
    ...
    prioForReminderContainer.innerText = selectedPriorityReminderLi;
    // console.log(selected.innerText);
    $('#reminderClose').trigger("click")
  })
})

getBackToHomeButton.addEventListener("click", function() {
...
async function getAllRemindersFromDb() {
  ...
  try {
    ...
    console.log(er);
    remindersTable.innerHTML = "Error404: " + er.message;
