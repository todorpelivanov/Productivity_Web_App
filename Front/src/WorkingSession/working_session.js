...
let suma;
let selectedDivPrio = document.getElementById("selectPrioDiv");
let selectedPaceOnHome = document.getElementById("selectPaceDiv");
...
selectedPriority.forEach((selected) => {
  selected.addEventListener("click", () => {
    ...
    selectedDivPrio.innerText = selectedPriorityLi;
    // console.log(selectedPriorityLi);
...
selectedPace.forEach((selected) => {
  selected.addEventListener("click", () => {
    ...
    selectedPaceOnHome.innerHTML = selectedPaceLi;
...
timerDownButton.addEventListener("click", () => {
  timerInput.value > 0 ? timerInput.value -1 : (timerInput.value = 0);
});
